...
if isa(surface1,'matlab.graphics.primitive.Patch')
    surface1_new.faces = surface1.Faces;
    surface1_new.vertices = surface1.Vertices;
    clear surface1
    surface1 = surface1_new;
end
if isa(surface2,'matlab.graphics.primitive.Patch')
    surface2_new.faces = surface2.Faces;
    surface2_new.vertices = surface2.Vertices;
    clear surface2
    surface2 = surface2_new;
end
